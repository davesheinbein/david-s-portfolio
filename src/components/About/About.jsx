                ...
                <div className='svgContainer'>
                    <svg id="_1cf4a4b6-30d3-491e-a53d-552d6204f4f6" data-name="1cf4a4b6-30d3-491e-a53d-552d6204f4f6"
                        ...
                        <g id="back-cape">
                            ...
                            <g id="cape-shadow">
                                <g>
                                    <path className="cls-2" d="M496.88,581a126.1,126.1,0,0,1,11.45-21.46L438,488.13Z" />
                                    ...
                                    <path className="cls-3" d="M438,488.13l70.35,71.36c11.28-17,26-29.91,42.58-39.78L364.37,372.14Z" />
                                </g>
                                <g className="cls-4">
                                    <path
                                        d="M281.38,194.32s50.57,15.17,121.38-7.59,217.45,32.88,217.45,32.88,94.1,0,238.14-53.36c11.39-30.12,37.49-55.38,37.49-55.38-172,73.33-288.28,73.33-288.28,73.33s-146.67-55.63-217.47-32.87-121.38,7.59-121.38,7.59c-35.4-2.53-20.23,27.82-20.23,27.82l10.41,16.41C261.06,197.62,267.11,193.3,281.38,194.32Z" />
                                    <path
                                        d="M873.11,232.25a63.41,63.41,0,0,1-7.26-6.93c-.58,14.93,4.57,29.78,19.9,42.33a79,79,0,0,1,11.18,11.06C897.42,262.49,890.39,246.39,873.11,232.25Z" />
                                </g>
                                <polygon className="cls-3" points="637.09 276.36 819.16 319.35 753.41 347.17 637.09 276.36" />
                            </g>
                        </g>
                        <g id="legs">
                            <g>
                        ...
                        <g id="body-rightarm">
                            <path className="cls-5" d="M398,66.49s-.52-23.36-16.93-36.22S377,76.46,377,76.46Z" />
                            <path className="cls-6"
                        ...
                        <g id="head">
                            <rect className="cls-5" x="279.61" y="155.76" width="37.28" height="41.94" rx="15.83" />
                            <circle className="cls-5" cx="293.59" cy="132.46" r="41.94" />
                        </g>
                        ...
                        <g id="cape-collar">
                            <path className="cls-1" d="M298.8,194v7.59S243.45,191.48,242,176.3l36.53,2.53Z" />
                            <path className="cls-1" d="M298.8,194v7.59s55.35-10.11,56.76-25.29L319,178.83Z" />
                            <path className="cls-1" d="M242.21,176.67s0-15.89,10.6-15.89S274,192.57,274,192.57Z" />
                        </g>
                        <circle id="spec_3" data-name="spec 3" className="cls-8" cx="11.56" cy="293.66" r="6.94" />
                        <circle id="spec_2" data-name="spec 2" className="cls-8" cx="98.27" cy="456.68" r="6.94" />
                        <circle id="spec_1" data-name="spec 1" className="cls-8" cx="837.05" cy="19.65" r="6.94" />
                        <path id="star_2" data-name="star 2" className="cls-9"
                        ...
                        <path id="star_1" data-name="star 1" className="cls-9"
                        ...
                        <circle id="circle_3" data-name="circle 3" className="cls-10" cx="587.32" cy="643.97" r="6.94" />
                        <circle id="circle_2" data-name="circle 2" className="cls-10" cx="11.56" cy="595.42" r="6.94" />
                        <circle id="circle_1" data-name="circle 1" className="cls-10" cx="566.51" cy="92.49" r="6.94" />
                        <g id="cross_1" data-name="cross 1" className="cls-11">
                            <rect className="cls-12" x="8.09" width="3.47" height="19.65" />
                            <rect className="cls-12" y="8.09" width="19.65" height="3.47" />
                        </g>
                        <g id="cross_2" data-name="cross 2" className="cls-11">
                            <rect className="cls-12" x="71.68" y="188.45" width="3.47" height="19.65" />
                            <rect className="cls-12" x="63.59" y="196.54" width="19.65" height="3.47" />
                        </g>
                        <g id="cross_3" data-name="cross 3" className="cls-11">
                            <rect className="cls-12" x="707.56" y="104.05" width="3.47" height="19.65" />
                            <rect className="cls-12" x="699.48" y="112.14" width="19.65" height="3.47" />
                        </g>
                    </svg>
                </div>
            </div>
