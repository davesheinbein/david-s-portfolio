							...
							<a
								...
								<div className='post-preview'>
									...
									<div className='post-intro'>
										A horse marketplace bulletin board.
										People can post horses they have for
										sale and contact people directly to
										inquire about buying a horse.
									</div>
						...
						<div className='post'>
							<a
								...
								<div className='post-preview'>
									...
									<div className='post-intro'>
										A easy to play game based on the card
										game War. Face off against against a
										computer! May the odds be in your favor!
									</div>
									<div className='viewMoreBtn'>
										<a
											href='https://github.com/davesheinbein/War-game'
